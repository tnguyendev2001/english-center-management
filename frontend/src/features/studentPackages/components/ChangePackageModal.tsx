      ...
      <Form form={form} layout="vertical" onFinish={handleFinish}>
        {currentPackage ? (
          <Descriptions title="Gói cũ" column={1} bordered size="small" style={{ marginBottom: 16 }}>
            ...
            <Descriptions.Item label="Thông tin nghỉ phép">
              {currentPackage.makeupAvailableSessions} đã ghi nhận
            </Descriptions.Item>
        ...
        {previewMatchesSelection && preview ? (
          <Space direction="vertical" size="middle" style={{ width: '100%' }}>
            ...
            <Alert
              type="info"
              showIcon
              message="Nghỉ phép chỉ để theo dõi, không cộng buổi học và không dùng để tính tiền trong V1."
            />
          </Space>
        ) : selectedPackageId ? (
          <Alert
